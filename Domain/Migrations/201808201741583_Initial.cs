namespace Domain.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Ganer = c.String(nullable: false),
                        Author = c.String(nullable: false),
                        ClientId_Id = c.String(maxLength: 128),
                    })
                ...
                c => new
                    {
                        ...
                        ClientOrder_Id = c.String(nullable: false, maxLength: 128),
                        OrderedBook_BookId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.OrderID)
                .ForeignKey("dbo.Clients", t => t.ClientOrder_Id, cascadeDelete: true)
                .ForeignKey("dbo.Books", t => t.OrderedBook_BookId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Books", "ClientId_Id", "dbo.Clients");
            ...
            DropIndex("dbo.Books", new[] { "ClientId_Id" });
